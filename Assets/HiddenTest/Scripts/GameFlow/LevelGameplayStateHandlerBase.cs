...
namespace HiddenTest.GameFlow
{
    ...
    public abstract class LevelGameplayStateHandlerBase : PresentableStateHandlerBase<GameState>, IStateHandler<GameState>
    {
        public override GameState State => GameState.LevelGameplay;

        public LevelGameplayStateHandlerBase(IGameStateNavigator gameStateNavigator,
